...
Add inline `<!-- SCAFFOLD: ... -->` comments to SKILL.md files documenting what each design choice compensates for in
terms of model limitations, and when it could safely be removed or simplified.

## Motivation

Anthropic's harness design paper emphasizes that every harness component encodes assumptions about model capabilities,
and these assumptions go stale as models improve. Documenting these assumptions makes it possible to systematically test
