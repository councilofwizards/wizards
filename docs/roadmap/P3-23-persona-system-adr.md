...
The persona system is the largest undocumented architectural decision in the project. 45+ personas with fictional
identities, the cross-reference structure, the dual communication style (terse agent-to-agent, personality-forward
...
- **Depends on P2-09** (Persona System Activation): ADR should document the completed system, not the broken
