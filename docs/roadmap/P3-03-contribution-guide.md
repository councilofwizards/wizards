...
The project has a README with installation and usage instructions, but lacks documentation for contributors. Someone
wanting to add a new skill, modify agent prompts, or contribute a stack hint has no guide to follow.

## Proposed Solution

1. **Architecture overview document**: Explain the plugin structure, skill format, agent team patterns, and quality gate
   design.
