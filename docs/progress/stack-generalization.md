...
Removed all hard-coded Laravel/PHP references from SKILL.md files. Replaced with framework-agnostic language. Added
stack detection step to Setup sections that reads dependency manifests and loads stack-specific hint files from
`docs/stack-hints/`.
