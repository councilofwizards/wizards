...
The plan-product team conducted review cycle 3 following the completion of P3-02 (Onboarding Wizard). The team confirmed
P3-22 (Investor Update / `/draft-investor-update`) as the next feature, produced a full system design, and wrote an
approved specification. P3-22 is the first business skill in the conclave framework and serves as the pathfinder for the
Pipeline collaboration pattern, dual-skeptic review model, and "quality without ground truth" requirements.
...
2. **5-agent team**: Researcher (opus), Drafter (sonnet), Accuracy Skeptic (opus), Narrative Skeptic (opus), plus Team
   Lead
