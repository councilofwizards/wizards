...
- **3-message cross-examination rounds**: Challenge -> Response -> Rebuttal (challenger gets last word), 2 mandatory
  rounds + 1 optional Lead-directed round
...
- **Dual-skeptic gate**: Bias Skeptic (fairness, legal, inclusive language) + Fit Skeptic (role necessity, budget,
  strategic fit)
...
The researcher and architect diverged on 5 fundamental design decisions. The skeptic rejected the first submission, and
the team lead resolved all 5:
