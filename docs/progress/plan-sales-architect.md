...
- [design start] Reference files read: business-skill-design-guidelines.md, investor-update-system-design.md,
  draft-investor-update/SKILL.md, plan-product/SKILL.md, P3-10-plan-sales.md, review-cycle-4-product-skeptic.md,
  skill-shared-content.sh
- [design start] Key constraints identified: (1) must define cross-referencing concretely, (2) scope to early-stage
...
- [review received] APPROVED with 2 non-blocking conditions:
  1. Spec must address Lead context management during synthesis (structured section-by-section synthesis or escalation
     behavior)
