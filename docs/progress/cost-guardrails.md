...
Added `--light` flag support to all 3 SKILL.md files and documented lightweight mode in README.md. Lightweight mode
reduces Opus agent usage for cost-sensitive invocations while preserving all quality gates. Cost summary steps added to
...
- **plan-product**: `--light` downgrades Researcher and Architect to Sonnet, removes DBA. Skeptic stays Opus. (~56%
  savings)
...
- All 3 skills now include a final orchestration step for the Team Lead to write a cost summary file to
