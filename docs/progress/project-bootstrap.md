...
Added directory-creation bootstrap step as Step 1 in all 3 SKILL.md Setup sections. Each skill now ensures
`docs/roadmap/`, `docs/specs/`, `docs/progress/`, and `docs/architecture/` exist before reading from them. Empty
