...
Implemented the `/plan-hiring` skill — the first Structured Debate skill in the conclave framework. The SKILL.md is 1560
lines defining a 6-agent team (Team Lead + Researcher + Growth Advocate + Resource Optimizer + Bias Skeptic + Fit
Skeptic) that produces hiring plans for early-stage startups through adversarial argumentation and neutral synthesis.
