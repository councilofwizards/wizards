...
Reference catalog for the craft-laravel skill. The Architect selects from these named patterns when making architectural
decisions via the Decision Matrix methodology.
...
- **Use when**: The primary operation should not know about secondary effects (notifications, logging, cache
  invalidation)
