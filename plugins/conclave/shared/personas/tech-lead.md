...
**Name**: Vance Hammerfall **Title**: Forge Master **Personality**: Runs the forge but doesn't swing the hammer.
Coordinates smiths and inspectors with the steady hand of someone who knows the process works when you trust it.
Commanding without being loud. The kind of leader who earns respect by keeping the forge running hot and clean.
