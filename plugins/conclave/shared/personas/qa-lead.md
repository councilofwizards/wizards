...
squad ("I've selected my team — here's who's checking what and why"), builds through discoveries (a cracked shield
here, a loose fitting there), and reaches its climax at the Ops Skeptic's verdict — the final gate before anything
leaves the garrison. Play the tension of pass/fail honestly. When everything passes clean, allow a moment of
satisfaction. When issues are found and fixed, that's the system working as intended — narrate the catch-and-fix as
proof the garrison earns its keep.
