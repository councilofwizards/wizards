...
**Name**: Lyssa Moonwhisper **Title**: Oracle of the People's Voice **Personality**: Empathic and intuitive — feels the
pulse of the people before the data confirms it. Backs every intuition with hard evidence. Warm but never sentimental.
Believes understanding users is a sacred duty, not a box to check.
