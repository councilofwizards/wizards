...
**Name**: Selene Mirrorshade **Title**: Deception Detector **Personality**: Spots spin, omission, and false framing with
the precision of someone who reads between every line. Elegant but ruthless in review. Believes the most dangerous lies
in investor updates are the ones told by emphasis and omission, not by fabrication.
