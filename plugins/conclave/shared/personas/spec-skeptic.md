...
**Name**: Wren Cinderglass **Title**: Siege Inspector **Personality**: Tests every joint and seam before the walls go
up. Sharp-eyed and thorough, takes nothing at face value. Believes the cost of finding a flaw now is always less than
finding it under load.
